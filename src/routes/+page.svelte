		...
		<div class="page flex flex-col py-12 items-start md:items-center justify-start md:py-56">
			...
			<form class="mt-16 w-full md:w-3/4" on:submit|preventDefault={handleSubmit}>
				...
				<div class="relative">
					...
					<button
						type="submit"
						class="text-white absolute right-2.5 bottom-2.5 bg-gradient-to-r to-pink-500 from-orange-400 hidden font-medium rounded-lg text-sm px-4 py-1.5 shadow transition-all hover:shadow-md focus:ring-4 focus:outline-none focus:ring-orange-300 md:block">
						Search
					</button>
				</div>
				<button
					type="submit"
					class="text-white bottom-2.5 bg-gradient-to-r to-pink-500 from-orange-400 font-medium rounded-lg text-sm px-4 py-3.5 md:py-2 w-full mt-4 focus:ring-4 focus:outline-none focus:ring-orange-300 md:hidden">
					Search
				</button>
			</form>
		</div>
	</div>
	<div class="page min-h-40 flex flex-col md:flex-row items-center px-8 py-32 md:py-20">
		...
		<div class="flex-1 flex flex-col">
			...
			<p class="mt-1 mb-4 text-gray-600 ">
				...
				<span
					class="font-medium text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-pink-500">
					Kantina.
				</span>
			</p>
			<a
				href="/register?type=merchant"
				class="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-100 rounded-lg hover:bg-gradient-to-r hover:from-orange-500 hover:to-pink-500 hover:text-white hover:shadow-lg transition-all">
