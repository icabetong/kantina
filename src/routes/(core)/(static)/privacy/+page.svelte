<div class="page min-h-screen text-gray-800 marker:text-red-600">
	...
	<div class="space-y-2">
		...
		<ul>
			...
			<li>
				...
				or &quot;Our&quot; in this Agreement) refers to Kantina.
			</li>
			<li>
			...
			<li>
				<strong>Website</strong> refers to Kantina, accessible from
				<a
					href="https://www.kantina.netlify.app"
					rel="external nofollow noopener noreferrer"
					target="_blank">https://www.kantina.netlify.app</a>
			</li>
			<li>
		...
		<ul>
			<li>
				...
				<a
					href="https://www.kantina.netlify.app/contact"
					rel="external nofollow noopener noreferrer"
					target="_blank">
					https://www.kantina.netlify.app/contact
				</a>
			</li>
		</ul>
	</div>
...
<svelte:head>
	<title>Privacy Policy - Kantina</title>
</svelte:head>
