<div class="page min-h-screen marker:text-orange-500">
	...
	<div class="space-y-2">
		...
		<p>
			These terms and conditions outline the rules and regulations for the use of Kantina Ltd.'s
			Website, located at https://kantina.netlify.app.
		</p>

		<p>
			By accessing this website we assume you accept these terms and conditions. Do not continue to
			use Kantina if you do not agree to take all of the terms and conditions stated on this page.
		</p>
		...
		<p>
			We employ the use of cookies. By accessing Kantina, you agreed to use cookies in agreement
			with the Kantina Ltd.'s Privacy Policy.
		</p>
		...
		<p>
			Unless otherwise stated, Kantina Ltd. and/or its licensors own the intellectual property
			rights for all material on Kantina. All intellectual property rights are reserved. You may
			access this from Kantina for your own personal use subjected to restrictions set in these
			terms and conditions.
		</p>

		<p>You must not:</p>
		<ul>
			<li>Republish material from Kantina</li>
			<li>Sell, rent or sub-license material from Kantina</li>
			<li>Reproduce, duplicate or copy material from Kantina</li>
			<li>Redistribute content from Kantina</li>
		</ul>
		...
		<p>
			...
			information in certain areas of the website. Kantina Ltd. does not filter, edit, publish or
			review Comments prior to their presence on the website. Comments do not reflect the views and
			opinions of Kantina Ltd.,its agents and/or affiliates. Comments reflect the views and opinions
			of the person who post their views and opinions. To the extent permitted by applicable laws,
			Kantina Ltd. shall not be liable for the Comments or for any liability, damages or expenses
			caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
			Comments on this website.
		</p>

		<p>
			Kantina Ltd. reserves the right to monitor all Comments and to remove any Comments which can
		...
		<p>
			You hereby grant Kantina Ltd. a non-exclusive license to use, reproduce, edit and authorize
		...
		<p>
			...
			visibility of the hyperlink compensates the absence of Kantina Ltd.; and (d) the link is in
		...
		<p>
			...
			to our website, you must inform us by sending an e-mail to Kantina Ltd.. Please include your
		...
		<p>
			No use of Kantina Ltd.'s logo or other artwork will be allowed for linking absent a trademark
			license agreement.
		</p>
